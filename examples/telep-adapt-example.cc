...
#include "ns3/telep-adapt-helper.h" // class TelepApphelper, TelepAppDstHelper

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("TelepAdaptExample");
...
main ()
{
  ...
  //
  std::vector<std::string> owners = {"Alice", "Bob", "God"};
  ...
  Ptr<QuantumNode> god = qphyent->GetNode ("God");
  nodes.Add (god);
